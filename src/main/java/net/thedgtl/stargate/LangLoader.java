...
public class LangLoader {
    ...
    public LangLoader(Stargate stargate, String datFolder, String lang) {
        ...
        if (is != null) {
            ...
            defList = null;
            stargate.getLogger().severe("Error loading backup language. There may be missing text ingame");
        }
    }
    ...
    public String getString(String name) {
        ...
        if (val == null && defList != null) {
            val = defList.get(name);
        }
        if (val == null) {
            return "";
        }
    ...
    private void updateLanguage(String lang) {
        ...
        if (updated) {
            stargate.getLogger().info("Your language file (" + lang + ".txt) has been updated");
        }
    }
